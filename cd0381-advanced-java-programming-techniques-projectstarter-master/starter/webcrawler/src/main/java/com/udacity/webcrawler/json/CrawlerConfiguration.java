...
//This annotation tells Jackson that CrawlerConfiguration uses the builder design pattern
...
public final class CrawlerConfiguration {
  ...
  public static final class Builder {
    ...
    //JsonProperty annotation define the mapping between JSON property names and builder methods
